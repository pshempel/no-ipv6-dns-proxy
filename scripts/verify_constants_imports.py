...
EXPECTED_CONSTANTS = {
    'DNS_DEFAULT_PORT', 'DNS_UDP_MAX_SIZE', 'DNS_TCP_MAX_SIZE',
    'DNS_QUERY_TIMEOUT', 'DNS_TCP_CONNECTION_TIMEOUT',
    'CACHE_MAX_SIZE', 'CACHE_DEFAULT_TTL', 'CACHE_MAX_TTL',
    'CACHE_CLEANUP_INTERVAL', 'CACHE_NEGATIVE_TTL',
    'RATE_LIMIT_PER_IP', 'RATE_LIMIT_BURST', 'RATE_LIMIT_WINDOW',
...
def get_imported_constants(tree):
    ...
    for node in ast.walk(tree):
        if isinstance(node, ast.ImportFrom):
            if node.module == 'dns_proxy.constants':
