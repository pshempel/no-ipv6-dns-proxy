...
from twisted.names import dns, client, error
...
class HealthMonitor:
            ...
            try:
                ...
                if not health.metrics.is_healthy and health.metrics.consecutive_failures == 0:
                    ...
                    if recent_successes >= self.config.recovery_threshold:
                        ...
                        logger.info(f"{health.server.name} marked healthy after {recent_successes} successes")
    ...
    def _handle_check_failure(self, health: ServerHealth, reason: str):
        ...
        if health.metrics.is_healthy and health.metrics.consecutive_failures >= self.config.failure_threshold:
    ...
    def record_query_result(self, server_name: str, result: QueryResult, 
    ...
    def get_statistics(self) -> Dict[str, dict]:
        ...
        return {
            name: health.metrics.get_statistics()
